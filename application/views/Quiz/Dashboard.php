<div class="jumbotron">
  ...
  <p><a class="btn btn-success btn-lg" href="<?=site_url('/Quiz/Create')?>" role="button">Criar um Quiz</a></p>
</div>
<div class="row">
    ...
    <div class="col-sm-6">
      <div class="thumbnail">
        ...
        <div class="caption">
          ...
          <p><?=$row->descricao?></p>
          <p>
            <a href="<?php echo site_url('/Quiz/Visualize/'.$row->id); ?>" class="btn btn-info" role="button" target="_blank">Vizualizar</a>
